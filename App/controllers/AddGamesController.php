<?php
namespace Controllers; // Déclare l'espace de noms 'Controllers' pour organiser les classes.

use Views\AddGamesViews; // Importe la classe 'AddGamesViews' depuis l'espace de noms 'Views'.
use Models\AddGamesModels; // Importe la classe 'AddGamesModels' depuis l'espace de noms 'Models'.
